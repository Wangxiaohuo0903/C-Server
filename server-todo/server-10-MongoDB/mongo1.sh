...
cd /usr/src/myapp && \
rm mongo-cxx-driver-r3.9.0.tar.gz

# 链接库
ldconfig
g++ -o myserver10 main.cpp -lsqlite3 -L/usr/local/lib -lmongocxx -lbsoncxx -I/usr/local/include/mongocxx/v_noabi -I/usr/local/include/bsoncxx/v_noabi