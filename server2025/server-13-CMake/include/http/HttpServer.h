...
public:
    ...
    // ★ Server-12更新：设置RESTful路由（需要inference和sessionMgr参数）
    void setupRESTfulRoutes(SimpleInference& inference, SessionManager& sessionMgr) {
        router.setupRESTfulRoutes(db, inference, sessionMgr);
    }
